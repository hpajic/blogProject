...
<title>Kylcus admin panel</title>
<!-- Bootstrap Styles-->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST" action="includes/delete-category.php">
                                        ...
                                        <div class="modal-body">
                                            <input type="hidden" name="category-id" value="<?php echo $id; ?>">
                                            <p>Are you sure u want to delete <?php echo $name ?>?</p>
                                            
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary" name="delete-category-btn">Delete it!</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
