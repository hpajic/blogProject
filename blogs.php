...
$numberBlogs = mysqli_num_rows($queryBlogs);
?>
        ...
        <div id="page-inner">
            ...
            if(isset($_REQUEST['deleteblogpost'])){
                if($_REQUEST['deleteblogpost'] == "success"){
                    ...
                    echo "<div class='alert alert-success'>
                    <strong>Danger!</strong> Blog Post was not deleted! Error occurred!
                </div>";
                }
            }
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class = "popup-button" onclick= "window.open('../single-blog.php?=<?php echo $blogPath; ?>', '_blank');">View</button>
                                        ...
                                        <div class="modal-content">
                                            <form method="POST" action="includes/delete-blog-post.php">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>Are you sure you want to delete blog with name of <?php echo $name; ?></p>
                                                    
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    <button type="submit" class="btn btn-primary" name="delete-blog-post-btn">Delete it!</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
